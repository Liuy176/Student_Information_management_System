...
<div>
    ...
    <main>
            ...
            <table>
                ...
                //caculate total column number

                $page_size = 13;  //Number of dosplays per page
    ...
    echo "<script>alert('you are not logged in,no permission to access to interface');location.href='login.php';</script>";
}
?>
</body>
</html>
